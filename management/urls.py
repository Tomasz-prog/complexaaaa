...
urlpatterns = [
    ...
    path('add_task/<int:projekt_id>', add_task, name="add_task"),
    path('add_projekt/', add_projekt, name="add_projekt"),
    path('remove_task/<int:zadanie_id><int:nr_projektu>', remove_task, name="remove_task"),
    path('delete_task/<int:projekt_id>', delete_task, name="delete_task"),
    path('check_task/<int:zadanie_id><int:nr_projektu>', check_task, name="check_task"),
